...
export const CHARACTERS: AnimeCharacter[] = [
  ...
  { id: 'naruto', name: 'Naruto Uzumaki', imageUrl: 'https://placehold.co/300x450.png', dataAiHint: 'anime ninja', description: 'The unpredictable knucklehead ninja of Konoha. (Update with direct image URL)', powerLevel: 7000 },
  { id: 'luffy', name: 'Monkey D. Luffy', imageUrl: 'https://placehold.co/300x450.png', dataAiHint: 'anime pirate', description: 'Captain of the Straw Hat Pirates, aiming to be Pirate King. (Update with direct image URL)', powerLevel: 8000 },
  { id: 'saitama', name: 'Saitama', imageUrl: 'https://placehold.co/300x450.png', dataAiHint: 'anime hero', description: 'A hero for fun, capable of defeating any enemy with a single punch. (Update with direct image URL)', powerLevel: 99999 },
