...
export const CHARACTERS: AnimeCharacter[] = [
  ...
  { id: 'levi', name: 'Levi Ackerman', imageUrl: 'https://uppearance.com/wp-content/uploads/2025/06/6.png', dataAiHint: 'anime soldier', description: "Humanity's strongest soldier in the fight against Titans.", powerLevel: 8500 },
];
